...
<html>
  ...
  <body >
    ...
    <div class="data-title">
        ...
        font-size: 2rem;  
        padding-left: 20px;">Small Basket<br></div>
    <div style="
    display: flex;
    flex-direction: column;
    align-items: flex-start; 
    padding-left: 20px;
    ">Indian Institute Of Information Technology, Lucknow</div>
    </div>
    ...
    width: 90px;
    margin-right:15px;
        " src="https://iiitl.ac.in/workshop/images/generic/Final_logo.png" />
    </div>
    <hr />
        <hr/>
        ...
        <div style="height:auto; padding: 20px;">
            ...
            Bank Name: HDFC BANK, Arjunganj, Lucknow<br/>
            Bank Account no : 92114201000<br/>
            Bank IFSC code : HDFC0004200<br/>
            </p>
